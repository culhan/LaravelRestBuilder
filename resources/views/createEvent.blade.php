...
@if (array_has($data,'name'))
    @section('title', 'Update Event '.Arr::get($data, 'name', ''))
@else
    ...
    <div class="col-lg-12">        
        <form id="modul">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom:0px">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="event-code" data-toggle="tab" href="#code" role="tab" aria-controls="code" aria-selected="false" index="code">Code</a>
                </li>                           
            </ul>
